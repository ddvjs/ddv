...
module.exports = {
  ...
  help: {
    ...
    command: {
      ...
      add: 'Add an site + set a name',
      remove: 'Remove an site',
      remove_alias: 'Remove an site(remove alias)',
      start_site: 'Start site',
      restart_site: 'Restart site',
      stop_site: 'Stop site',
      start: 'Start ddv server',
      restart: 'Restart ddv server',
      reload: 'Reload the ddv server site changes',
      stop: 'Stop ddv server'
    }
  },
  command: {
    tail: {
