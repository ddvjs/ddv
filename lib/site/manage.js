'use strict'
const debug = require('debug')('lib/site/manage')
// ddv路径模块
...
const manage = module.exports = {
  add (data, callback) {
    ...
    q = b.queue().onError(function onError (err) {
      ...
      if (siteId) {
        ...
        // 取得最后的siteId
        let i, lastSiteId = ((siteIds[0] || 0) + 1) || 1
      ...
      if (callback) {
        manage.saveLists(lists, callback)
        callback = void 0
        lists = void 0
        q.abort()
      }
  ...
  remove (data, callback) {
    ...
    q = b.queue().onError(function onError (err) {
      ...
      manage.lists(function listsCb (err, l) {
        lists.push.apply(lists, l || [])
        l = err = void 0
        next()
      })
      ...
      manage.saveLists(lists, function saveListsCb () {
