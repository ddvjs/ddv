...
commander
.command('start')
.description(log.t('cli.help.command.start'))
...
.description(log.t('cli.help.command.restart'))
...
commander
.command('reload')
.description(log.t('cli.help.command.reload'))
...
commander
.command('stop')
.description(log.t('cli.help.command.stop'))
